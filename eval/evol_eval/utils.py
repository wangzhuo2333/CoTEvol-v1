...
PROMPT_TEMPLATES = {
    ...
    "qwen25it-math-cot": (
        "<|im_start|>system\nYou are an expert in math. Below is a math question. "
        "Write a response that appropriately answers the question. The final answer should be formatted as $\\boxed{{}}$. "
...
def construct_prompt(example, data_name, args):
    ...
    if args.prompt_type in ["qwen25-math-cot"]: # "qwen25it-math-cot"
