...
def get_tokenizer(args,
                  model, padding_side="left", strategy=None, use_fast=True):
    ...
    if tokenizer.chat_template is None:
        ...
        chat_template = "{% for message in messages %}{{message['role'] + ': ' + message[" \
        ...
        strategy.debug("using mistral chat_template")
        chat_template = tokenizer.chat_template
    else:
