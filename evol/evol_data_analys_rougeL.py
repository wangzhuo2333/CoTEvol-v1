...
tokenizer = AutoTokenizer.from_pretrained("/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/Qwen2.5-7B-Instruct")
...
# data_path = '/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/output/math_evol/evol_data/limo_self_refine_v1.0_-.pkl'
s1k_path = '/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/ifdr-main-v2/ifdr-main-qwen1.5/evol/wz_output_s1k_7b/evol_s1k/v1.1/evol_s1k_-.pkl'
# s1k_path = '/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/output/math_evol/evol_s1k/v1.1/evol_s1k_m.pkl'
limo_path = '/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/ifdr-main-v2/ifdr-main-qwen1.5/evol/wz_output_limo/evol_limo/v1.1/evol_limo_-.pkl' 
s1k_refine_path = '/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/output/math_evol/evol_data/s1k_self_refine_v1.0_-.pkl'
limo_refine_path = '/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/output/math_evol/evol_data/limo_self_refine_v1.0_-.pkl'

with open(limo_refine_path, "rb") as file:
...
for dp in dps:
    ...
    if len(evol_solutions) != 0:
        ...
        if init_right:
            int_r += 1
            init_results.append(copy.deepcopy(init_result))
        if evol_right:
            evol_r += 1
            evol_results.append(copy.deepcopy(evol_result))
        if not evol_right:
    ...
    # TODO 进化之后多样性变化
torch.save(evol_results, "/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/ifdr-main-v2/ifdr-main-qwen1.5/evol/wz_test/rougeL_different_questions/limo_self_refine.pt")
# torch.save(init_results, "/inspire/hdd/WORKSPACE_ID/public-project/USER_ID/ifdr-main-v2/ifdr-main-qwen1.5/evol/wz_test/rougeL_different_questions/limo_best_of_n.pt")
